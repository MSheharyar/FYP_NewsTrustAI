...
class _VerifyTextScreenState extends State<VerifyTextScreen> {
  ...
  Future<void> _verifyText() async {
    ...
    final result = await ApiService.verifyText(rawText, query: query);
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "Enter a news headline or paragraph to verify...",
                      filled: true,
        ...
        // Animated loading overlay — shown on top of everything
